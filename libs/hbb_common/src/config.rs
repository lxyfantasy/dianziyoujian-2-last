...
lazy_static::lazy_static! {
    pub static ref ORG: RwLock<String> = RwLock::new("com.myapp".to_owned());
}
...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("DevBox".to_owned());
...
lazy_static::lazy_static! {
    pub static ref HELPER_URL: HashMap<&'static str, &'static str> = HashMap::from([
        ("myapp docs home", LINK_DOCS_HOME),
        ("myapp docs x11-required", LINK_DOCS_X11_REQUIRED),
        ("myapp x11 headless", LINK_HEADLESS_LINUX_SUPPORT),
        ]);
}
